var scmMgt = function(page) {
    ...
    function init() {
        ...
        // SCM 목록 조회(2023년 4월 19일 추가)
        page.multiSelect('[name="scmCdList"]', {
            send: {
                    url: '/rest/system/get-scm',
                    method: 'GET',
            },
            id: 'scmCd',
            text: 'scmNm',
    ...
    function scmListGrid(){
        ...
        // scm 선택을 안 하면 list 보내줄 떄 null로 변경(2023년 4월 19일 추가)
        if(page.$("[name='scmCdList'] option:selected").val() == undefined) {
            params.scmCdList = null;
        }

        console.log('SCM 목록 조회 조건 : ', params);
